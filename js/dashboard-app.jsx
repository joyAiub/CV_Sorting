...
const Sidebar = ({ 
    ...
    return (
        ...
        function Dashboard() {
            ...
            useEffect(() => {
                const initColumns = async () => {
                    ...
                    try {
                        const result = window.__prefetchedColumns
                            ? await window.__prefetchedColumns.finally(() => { window.__prefetchedColumns = null; })
            ...
            return (
                <div className="flex flex-col h-full bg-slate-50 relative text-slate-800">
                                                    ...
                                                    .map(emp => (
                                                        ...
                                                        >
                                                            ...
                                                            <div className="flex-1 min-w-0">
                                                                ...
                                                                <p className="text-[10px] font-bold text-slate-500 uppercase tracking-tight truncate">{emp.designation} â€¢ {emp.department}</p>
                                                            </div>
                    ...
                    {/* Reviewer Identity Modal â€” shown once per session for public view */}
                    ...
                    <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
                        ...
                        <div className="px-6 py-6">
                            ...
                            <div className="mb-4">
                                ...
                                {/* Fixed-height feedback area â€” prevents layout shift */}
                            ...
                            {/* Employee info card â€” shown only when authorized */}
                                ...
                                <div className="mb-5 bg-emerald-50 border border-emerald-200 rounded-xl p-4 animate-in fade-in duration-200">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="min-w-0">
                                            ...
                                            <p className="text-slate-500 text-[11px] truncate">{empInfo.designation}{empInfo.department ? ` Â· ${empInfo.department}` : ''}</p>
        ...
        function CellContent({ id, candidate, sl, expanded, openPdf, jdId, onToggle, editingRowId, setEditingRowId, isPublic, onFeedbackSave }) {
            ...
            if (id === 'expected_salary') return <span className="font-bold text-slate-900">à§³{parseFloat(candidate.expected_salary).toLocaleString()}</span>;
            if (id === 'match') {
