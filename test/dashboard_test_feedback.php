...
// Reviewer identity — from URL params embedded by send_filtered_mail.php
// reid is an HMAC token (not a raw emp_id), so it reveals nothing about the invited person
...
<body class="h-full overflow-hidden">
    ...
    <script type="text/babel">
        ...
        function Dashboard() {
            ...
            // Reviewer identity — persisted per-task in sessionStorage
                ...
                if (result.isConfirmed && result.value) {
                    ...
                    if (val.submission_no) {
                        ...
                        Swal.fire({
                            ...
                            text: val.message || 'Something went wrong. Please try again.'
                        });
                    }
                }
            };
